 ...
 *
 * % java Brute bcara abacadabrabracabracadabrabrabracad text:
 * abacadabrabracabracadabrabrabracad pattern: bcara
 * 
 * % java Brute abacad abacadabrabracabracadabrabrabracad text:
 * abacadabrabracabracadabrabrabracad pattern: abacad
 *
 ******************************************************************************/

public class Brute implements SubStringSearchAlgorithm {
	 ...
	 */
	@Override
	public void process(String pat, String txt) {
